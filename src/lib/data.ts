...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    rating: 5,
    comment: 'Exceptional service and stunning architecture. The attention to detail in every corner of this hotel is remarkable.',
    avatar: 'avatar-john-smith',
  },
  {
    id: 5,
    ...
    rating: 5,
    comment: 'A perfect getaway. The spa facilities are world-class and the staff made us feel incredibly welcome.',
    avatar: 'avatar-jane-doe',
  },
  {
    id: 6,
    ...
    location: 'London, UK',
    rating: 4,
    comment: 'Great location and beautiful rooms. The breakfast spread was delicious with plenty of options.',
    avatar: 'avatar-john-smith',
  },
  {
    id: 7,
    ...
    rating: 5,
    comment: 'We celebrated our anniversary here and it was magical. The room upgrade was a lovely surprise!',
    avatar: 'avatar-emily-jones',
  },
  {
    id: 8,
    ...
    rating: 5,
    comment: 'Business travel made a pleasure. Excellent high-speed wifi and the desk in the room was perfect for working.',
    avatar: 'avatar-john-smith',
  },
];
